...
class applicantnav extends HTMLElement {
    constructor() {
      super();
    }

 connectedCallback(){
        this.innerHTML =`<div class="card border-1 bg-dark">
        <div class="card-body d-inline-flex p-auto overflow-auto">
            ...
            <div> <a href="jobsGivenPage.php" class="btn fs-4 btn-dark text-light">
            ...
            <div> <a href="jobsAcceptedPage.php" class="btn fs-4 btn-dark text-light">
            ...
            <div> <a href="..//index.php" class="btn fs-4 btn-dark text-light" name = "logOut">
...
customElements.define('app-applicantnav', applicantnav);



//Company Navigation bar
class companynav extends HTMLElement {
    constructor() {
      super();
    }
 ...
 connectedCallback(){
        ...
        <div class="card-body d-flex overflow-auto">
            ...
            <div> <a href="donate.php" targert="_blank" class="btn fs-4 btn-dark text-light">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-box-arrow-up-right" viewBox="0 0 16 16">
                    <path fill-rule="evenodd" d="M8.636 3.5a.5.5 0 0 0-.5-.5H1.5A1.5 1.5 0 0 0 0 4.5v10A1.5 1.5 0 0 0 1.5 16h10a1.5 1.5 0 0 0 1.5-1.5V7.864a.5.5 0 0 0-1 0V14.5a.5.5 0 0 1-.5.5h-10a.5.5 0 0 1-.5-.5v-10a.5.5 0 0 1 .5-.5h6.636a.5.5 0 0 0 .5-.5z"/>
                    <path fill-rule="evenodd" d="M16 .5a.5.5 0 0 0-.5-.5h-5a.5.5 0 0 0 0 1h3.793L6.146 9.146a.5.5 0 1 0 .708.708L15 1.707V5.5a.5.5 0 0 0 1 0v-5z"/>
                </svg> Donate </a>
...
customElements.define('app-companynav', companynav);
        ...
        <a class="navbar-brand text-light btn btn-dark" href="index.php">
            ...
            <div class="container bg-dark">
                <div class="card m-1 border-0 bg-dark" style="width: 30rem;">
                    <div class="card-body">
                        <a href="..//..//applicant//applicantRegLogin.php" class="btn btn-dark fs-4 text-light">Apply for Jobs</a><br>
                        <a href="..//..//company//companyRegLogin.php" class="btn btn-dark fs-4 text-light">Hire</a><br>
                        <a href="#" class="btn btn-dark fs-4 text-light">Terms and Conditions</a><br>
                        <a href="#" class="btn btn-dark fs-4 text-light">About Us</a><br>
                        <a href="#" class="btn btn-dark fs-4 text-light">Contacts</a><br>
                    </div>
                </div>
    
                <div class="card m-1 border-0 bg-dark text-light" style="width: 30rem;">
                    <div class="card-body fs-5">
                        <p>Isn't it interesting exploiting local talent? you can even interact using our swahili dialect. If you have any comments or complains about our website do not hesitate to reach out.</p>
            ...
            <!-- Calling icon -->
                ...
                <div class="card m-4 border-0 bg-dark" style="width: 60rem;">
                    <div class="card-body text-center">
    
                    <!-- Instagram Icon -->
                    <a href="http://" target="_blank" rel="noopener noreferrer" class="btn text-light btn-dark">
...
/* <div> <a href="applicantNotificationPage.php" class="btn fs-4 btn-dark text-light">
