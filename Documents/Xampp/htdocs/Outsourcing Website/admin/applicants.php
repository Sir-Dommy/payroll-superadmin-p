...
foreach ($_POST as $key => $value){
    ...
    if($block == 'unb'){
        ...
        status = 'Verified' WHERE applicantEmail = '$email'";
    
        if(mysqli_query($mysqli, $sql)){
            echo "<script> alert('Applicant Unblocked Successively')</script>";
        }
    
    }
    else if($block == 'blo'){
        $sql = "UPDATE applicantdetails SET
        status = 'Blocked' WHERE applicantEmail = '$email'";
        if(mysqli_query($mysqli, $sql)){
            echo "<script> alert('Applicant Blocked Successively')</script>";
        }
    }
}
        ...
        <!-- </div>
            ...
            <div class="card m-2 border-1">
                <div class="card-body">
                   ...
                   <!-- Jobs Issued -->
                   <h4 class='text-center mt-1'>Applicants</h4>
                   ...
                   <div class="card border-0 overflow-auto" style="height: 4rem;">
                        <div class="mx-auto">
                            ...
                            <form action="" method="POST">
                                ...
                                <button type="Submit" name = "viewAllApplicants" class="btn btn-primary m-1" data-bs-dismiss="modal">View All Applicants</button> 
                                <button type="Submit" name = "viewRegisteredApplicants" class="btn btn-success m-1" data-bs-dismiss="modal">View Registered Applicants</button> 
                                <button type="Submit" name = "viewVerifiedApplicants" class="btn btn-primary m-1" data-bs-dismiss="modal">View Verified Applicants</button>  
                                <button type="Submit" name = "viewBlockedApplicants" class="btn btn-danger m-1" data-bs-dismiss="modal">View Blocked Applicants</button>  
                        ...
                        <table class="table table-hover">
                            ...
                            <tbody>
                                ...
                                <?php
                                    ...
                                    if(isset($_POST['viewRegisteredApplicants'])){
                                        echo "<div class = 'text-center'> <b>These are the applicants applicants who are yet to be verified</b> </div>";
                                        
                                        $sql = "SELECT * FROM applicantDetails WHERE status = 'Registered'";
                                        ...
                                        if(mysqli_num_rows($res)<1){
                                            echo "
                                            <tr>
                                                <td colspan='20' class='text-danger text-center'>No Matching data was found!!!</td>
                                            </tr>";
                                        }

                                    }

                                    else if(isset($_POST['viewBlockedApplicants'])){
                                        echo "<div class = 'text-center'> <b>These are the blocked applicants </b> </div>";
                                        
                                        $sql = "SELECT * FROM applicantDetails WHERE status = 'Blocked'";
                                    ...
                                    else if(isset($_POST['viewVerifiedApplicants'])){
                                        echo "<div class = 'text-center'> <b>These are the blocked applicants </b> </div>";
                                        
                                        $sql = "SELECT * FROM applicantDetails WHERE status = 'Verified'";
                                        ...
                                        echo "<div class = 'text-center'> <b>These are the registered applicants </b> </div>";
        ...
        $('#liveSearch').keyup(function(){
            ...
            if(searchApplicant != ""){
                $.ajax({
                    ...
                    url: "search.php",
                    method: "POST",
                    data:{searchApplicant:searchApplicant},
